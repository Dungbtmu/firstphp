...
// $number = ++$first; //tại thời điểm gọi thì giá trị first đc tăng thêm 1, sau đó mới gán cho $number --> giá trị luôn luôn tăng 1
// $number2 = $second++; // sau khi gọi xong giá trị mới tăng
// echo $number. '-'.$first;
// echo '-'.$number2. '-'.$second;
...
// // ==: so sánh về giá trị
// $test = 1 =='1'; //true
// $test1 = 1 ==='1'; //false //===: so sánh cả kiểu dữ liệu
// $test2 = '4aaaaaaaa' > 2; // true
// $test3 = '4' > 2; // true
...
// }
// //chỉ nên if-else ở 3 tầng điều kiện
...
// }
// // được dùng cho hầu hết với mảng
...
// //Vòng lặp While - chạy vòng lặp chưa bt trc
// /* $matKhau = '123';
// while($matKhau !='12345')
// {
//     echo 'nhap sai';
//     $matKhau = hamnhaplainatkhau();
// } */
...
// {
//     echo $index.'-';
//     for($index2 = 11. $index2 <12; $index2++)
//     {
//         if($index ==2)
//         {
//             break;
...
// // Function
// function sumNumber($first, $number)
// {
//     return $first + $number;
// }
...
// //mảng
// $users = ['name',1,2,3,'test'];
// $users[0] = 'Test';


// array_splice($users); //Xóa phần tử
...
$mang = [2, 3, 7, 9, 1];
$ketQua = timMinMax($mang);

echo "Giá trị nhỏ nhất: " . $ketQua['min'] . "<br>";
echo "Giá trị lớn nhất: " . $ketQua['max'];
...
echo "Giai thừa của $n là: $ketQua";
...
//Kiểm tra 1 số có phái số nguyên tố khôgn
